...
<div class="container p-0">
    <div class="row">
        <div class="col-md-12">
            <h1 class="text-light text-center m-3">KI-OON</h1>
            <p class="text-light p-3">Ki-oon est une maison d'édition française spécialisée dans le manga fondée en octobre 2003. </p>
        </div>
    </div>
</div>
...
<div class="container p-0">
    <div class="row">
        <div class="col-md-2 d-flex mx-auto">
            <button type="button" class="btn btn-link"><a href="kioonActu.php">Actualité</a></button>
