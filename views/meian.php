...
<div class="container p-0">
    <div class="row">
        <div class="col-md-12">
            <h1 class="text-light text-center m-3">MEIAN</h1>
            <p class="text-light p-3">Meian est une maison d'édition française créée en 2017 et spécialisée dans l'édition de mangas et de manhwas. </p>
        </div>
    </div>
</div>
...
<div class="container p-0">
    <div class="row">
        <div class="col-md-2 d-flex mx-auto">
            <button type="button" class="btn btn-link"><a href="meianActu.php">Actualité</a></button>
