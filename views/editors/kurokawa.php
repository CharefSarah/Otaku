...
<div class="container p-0">
    <div class="row">
        <div class="col-md-12">
            <h1 class="text-light text-center m-3">KUROKAWA EDITION</h1>
            <p class="text-light p-3">Kurokawa est une maison d'édition spécialisée dans le manga créée en septembre 2005. Kurokawa est le label d'Univers Poche spécialisé dans l'édition de mangas. </p>
        </div>
    </div>
</div>
